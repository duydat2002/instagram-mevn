...
const { removePostPopupShow, removeMediaPopupShow } = storeToRefs(useCreatePostStore());
...
const handleDeleteMedia = () => {
  if (medias.value.length > 1) removeMediaPopupShow.value = true;
  else removePostPopupShow.value = true;
};
